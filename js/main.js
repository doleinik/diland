...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_three_OrbitControls___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_three_OrbitControls__);
        ...
        const containerEl = document.getElementsByClassName('tn-elem__1808846441586951373539')[0];
...
//Добавляем класс к 4 цифре
$(".t506__title:eq(3)").addClass("numberup3");
...
$(function () {
    ...
    $(window).scroll(function () {
        ...
        if (scrollEvent && blockStatus) {
            ...
            //Анимация цифры 1
            $({ numberValue: 0 }).animate({ numberValue: 79 }, {
            ...
            $({ numberValue: 0 }).animate({ numberValue: 90 }, {
                ...
                step: function (val) {
                    ...
                    $(".numberup1").html(format + '%'); // Блок, где необходимо сделать анимацию
                }
            });
            //Анимация цифры 3
            $({ numberValue: 0 }).animate({ numberValue: 79 }, {
                ...
                easing: "swing",
                step: function (val) {
                    $(".numberup2").html(Math.ceil(val) + ''); // Блок, где необходимо сделать анимацию
                }
            });
            //Анимация цифры 4
            $({ numberValue: 0 }).animate({ numberValue: 90 }, {
                ...
                step: function (val) {
                    var numpsace = Math.ceil(val);
                    var format = String(numpsace).replace(/(\d)(?=(\d{3})+([^\d]|$))/g, '$1 ');
                    $(".numberup3").html(format + '%'); // Блок, где необходимо сделать анимацию
                }
            });
        }
    });
